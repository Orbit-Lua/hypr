...
- `lua/config/autostart.toml` is limited to compositor-owned runtime work. It
  ...
  to the parent dotfiles repository and Homebase.
...
- Do not duplicate Vicinae, hyprpolkitagent, KeePassXC, Noctalia, Quickshell
  Overview, tray applets, Vesktop, or system XDG autostart entries in
